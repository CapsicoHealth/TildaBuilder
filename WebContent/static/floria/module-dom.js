    ...
    getElement : function(e, throwMsg)
      {
        if (e == null)
         {
           console.warn("FloriaDOM.getElement() called with null 'e'.");
     ...
     addEvent: function(elementId, eventName, handlerFunc, delayedMillis)
      {
        ...
        if (delayedMillis == null)
          ...
          e.addEventListener(eventName, function(event) { FloriaDOM.DelayedEvent.register(elementId, delayedMillis, function() { handlerFunc(e, event, event.target); }); });
      },
