...
(function (exports, ElementView_mjs, Link_mjs, basic_mjs) {
    ...
    var Class = basic_mjs.Generic.define('uml.Class', {
        attrs: {
            ...
            '.uml-class-attributes-pk-text': {
                'ref': '.uml-class-attributes-pk-rect', 'ref-y': 5, 'ref-x': 5,
                'fill': 'black', 'font-size': 12, 'font-family': 'Courier'
            }
        },
        ...
        markup: [
            ...
            '<rect class="uml-class-attributes-fk-rect"/>',
            '<rect class="uml-class-attributes-pk-rect"/>',
            '</g>',
            '<text class="uml-class-name-text"/>',
            '<text class="uml-class-attrs-text"/>',
            '<text class="uml-class-attributes-fk-text"/>',
            '<text class="uml-class-attributes-pk-text"/>',
            '</g>'
        ].join(''),

        initialize: function() {
            this.on('change:name change:attributes change:methods change:attributesFk change:attributesPk', function() {
        ...
        splitAttribute: function(attribute) {
            try{
                ...
                if (this.get('longestAttributeLength') > parts[0].length) {
                    if (length > 25){
                        parts[0] = parts[0] + "...";
